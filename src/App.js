...
export default function App() {
  return (
    <EntryWrapper>
      ...
      <Footer>
        <span>
          <FooterLink href="mailto:mjuudev@gmail.com" target="blank">
            <FooterIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <span>
          <FooterLink
            href="https://github.com/pmjuu/climick-client"
            target="blank"
          >
            <FooterIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
        ...
        <span>
          <FooterLink href="https://www.instagram.com/mjuuclimb" target="blank">
            <FooterIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <span>
          <FooterLink
            href="https://www.youtube.com/watch?v=w5qo4VSKXTo"
            target="blank"
          >
            <FooterIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
